          ...
          <div className="product-info">
            ...
            <div className="flex flex-col gap-4">
              <div className = "flex gap-3 ">
                <div className = "product-star.svg">
                ...
                <div className = "rpoduct-reviews"><Image src = "/assets/icons/comment.svg" alt = "comment" width = {16} height= {16}/>
                <p className="text-sm text-secondary font-semibold">{product.reviewsCount} Reviews
                  </p>
                  </div>
              </div>
              <p>
                <span>93 %</span> of 
                buyesrs have recommended this
              </p>
            </div>
          </div>
          <div>
